...
#endif
class ModeHoming : public Mode
{
public:

    Number mode_number() const override { return Number::HOMING; }
    const char *name() const override { return "Homing"; }
    const char *name4() const override { return "HOMG"; }
